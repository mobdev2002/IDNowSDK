...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="IDNowSDKCore",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif


SWIFT_CLASS("_TtC12IDNowSDKCore14DocumentOption")
@interface DocumentOption : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12IDNowSDKCore13IDNowEndpoint")
@interface IDNowEndpoint : NSObject
...
enum IdentResult : NSInteger;

SWIFT_CLASS("_TtC12IDNowSDKCore8IDNowSDK")
@interface IDNowSDK : NSObject
- (void)startWithToken:(NSString * _Nonnull)token preferredLanguage:(NSString * _Nonnull)preferredLanguage fromViewController:(UIViewController * _Nonnull)fromViewController listener:(void (^ _Nonnull)(enum IdentResult, NSString * _Nonnull))listener;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

typedef SWIFT_ENUM(NSInteger, IdentResult, closed) {
  IdentResultFINISHED = 0,
  IdentResultCANCELLED = 1,
  IdentResultERROR = 2,
};
...
SWIFT_CLASS("_TtC12IDNowSDKCore14IDNowSDKConfig")
@interface IDNowSDKConfig : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC12IDNowSDKCore21IDNowSDKConfigBuilder")
@interface IDNowSDKConfigBuilder : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC12IDNowSDKCore15IQBarButtonItem")
...
SWIFT_CLASS("_TtC12IDNowSDKCore28IQBarButtonItemConfiguration")
...
SWIFT_CLASS("_TtC12IDNowSDKCore12IQInvocation")
...
SWIFT_CLASS("_TtC12IDNowSDKCore17IQKeyboardManager")
...
SWIFT_CLASS("_TtC12IDNowSDKCore26IQKeyboardReturnKeyHandler")
...
SWIFT_CLASS("_TtC12IDNowSDKCore18IQPreviousNextView")
...
SWIFT_CLASS("_TtC12IDNowSDKCore10IQTextView")
...
SWIFT_CLASS("_TtC12IDNowSDKCore20IQTitleBarButtonItem")
...
SWIFT_CLASS("_TtC12IDNowSDKCore9IQToolbar")
...
SWIFT_CLASS("_TtC12IDNowSDKCore9IntroItem")
...
@interface UIScrollView (SWIFT_EXTENSION(IDNowSDKCore))
...
@interface UIView (SWIFT_EXTENSION(IDNowSDKCore))
/// <hr/>
...
@interface UIViewController (SWIFT_EXTENSION(IDNowSDKCore))
/// To set customized distance from keyboard for textField/textView. Can’t be less than zero
